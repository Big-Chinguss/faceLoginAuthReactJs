...
{/* 
            ...
            <div className="my-wrap-input wrap-input50 wrap-input50-m" onClick={() => enableInput('PIN')}>
                <input
                    type="pin"
                    name="register-pin"
            ...
            <div className="my-wrap-input wrap-input50" onClick={() => enableInput('repeat-PIN')}>
                <input
                    type="pin"
                    name="repeat-pin"
                    id="repeat-password"
